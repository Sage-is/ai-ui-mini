...
// Type-only: importing the module namespace at runtime would create a cycle
// (filesystem.ts reads FileSystemSearch.node while building its own node), which
// bundling resolves in the opposite order and leaves that dependency undefined.
